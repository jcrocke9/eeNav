...
export interface IEENavProps { }
export interface IEENavState { }
export class EENav extends React.Component<IEENavProps, IEENavState> {
    constructor(props: IEENavProps, state: IEENavState) {
        super(props);
